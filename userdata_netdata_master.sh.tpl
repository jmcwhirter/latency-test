...
echo '# no need for shebang - this file is sourced from fping.plugin
...
#fping_opts="-R -b 56 -i 1 -r 0 -t 5000"' > /etc/netdata/fping.conf


echo -e "${host_entries}" >> /etc/hosts


sed -i "s/# fping/fping/" /etc/netdata/netdata.conf
